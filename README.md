...
[![Release](https://img.shields.io/badge/release-1.0.1-35d0d0)](https://github.com/AuthorityGate/RackSight/releases/tag/v1.0.1)
...
Download the signed installer from [GitHub Releases](https://github.com/AuthorityGate/RackSight/releases/tag/v1.0.1):

- `RackSight-Setup-1.0.1-x64.exe` — guided system-wide installation to `C:\Program Files\AuthorityGate\RackSight`
- `RackSight-Portable-1.0.1-x64.exe` — no installation required
