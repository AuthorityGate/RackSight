...
[![Release](https://img.shields.io/badge/release-1.1.3-35d0d0)](https://github.com/AuthorityGate/RackSight/releases/tag/v1.1.3)
...
Download the signed installer from [GitHub Releases](https://github.com/AuthorityGate/RackSight/releases/tag/v1.1.3):

- `RackSight-Setup-1.1.3-x64.exe` — guided system-wide installation to `C:\Program Files\AuthorityGate\RackSight`
