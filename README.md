...
[![Release](https://img.shields.io/badge/release-1.1.0-35d0d0)](https://github.com/AuthorityGate/RackSight/releases/tag/v1.1.0)
...
Download the signed installer from [GitHub Releases](https://github.com/AuthorityGate/RackSight/releases/tag/v1.1.0):

- `RackSight-Setup-1.1.0-x64.exe` — guided system-wide installation to `C:\Program Files\AuthorityGate\RackSight`
- `RackSight-Portable-1.1.0-x64.exe` — no installation required
